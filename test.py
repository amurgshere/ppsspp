...
tests_ignored = [
  # Both require real hardware behavior PPSSPP intentionally doesn't emulate at
  # this level (proprietary KIRK crypto keys / literal second ME CPU core).
  # Ignored upstream too, not fork-specific.
  "kirk/kirk",
  "me/me",
]
